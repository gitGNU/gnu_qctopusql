 ...
 *  accept or reject
 */
AliasesDeleteDialog::AliasesDeleteDialog(QSqlDatabase db, QTableWidget *Table){
 ...
 * Delete aliases.
 */
void AliasesDeleteDialog::Delete(){
	...
	if( db_psql.isOpen() ){ 
		...
		query.prepare("DELETE FROM aliases WHERE local_part=:login and id_domain=get_domain_id(:domain)");
 ...
 * Test connection.
 */
void AliasesDeleteDialog::TestQuery(){
